...
class ReminderAgent(BaseAgent):
    def __init__(self, config: Optional[AgentConfig] = None) -> None:
        super().__init__(config=config or AgentConfig(agent_type="reminder"))
    ...
    def invoke_rag(self, context: AgentContext) -> AgentResponse:
        return AgentResponse.error("ReminderAgent not yet implemented", session_id=context.session_id)
